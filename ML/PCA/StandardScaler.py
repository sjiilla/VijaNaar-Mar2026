...
from sklearn import decomposition, preprocessing #PCA Package
#from sklearn.decomposition import PCA #Alternative way

#4 features with 5 records
df1= pd.DataFrame({
        'SibSp':[1,2,50,4,5],
        'FamilySize':[2,4,150,25,10],
        'Age':[10,1000,8500,40,1],      
        'Fare':[100,6,300,400,2000]})
...
# 
# =============================================================================
pca = decomposition.PCA(n_components=4) #n_components means, transform the data to n dimensions.
