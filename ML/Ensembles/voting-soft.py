# -*- coding: utf-8 -*-
"""
Created on Fri Apr 14 07:38:04 2026
...
print(grid_voting_estimator.best_params_) #Avg CV score & Best Params score
...
os.getcwd()
titanic_test.to_csv('Voting_Soft.csv', columns=['PassengerId','Survived'],index=False)
