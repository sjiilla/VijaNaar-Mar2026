# -*- coding: utf-8 -*-
"""
Created on Sun May 11 20:00:53 2026
...
crossValidate = model_selection.cross_validate(linr_estimator, X_train1, y_train, cv=10, scoring=metrics.make_scorer(rmse), return_train_score=True)
