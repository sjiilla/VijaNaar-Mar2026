# -*- coding: utf-8 -*-
"""
Created on Thu Apr 2 07:23:06 2026
...
#FireplaceQu - For Fireplaces 0, FireplaceQu is set to NA, 
#indicating No Fireplace, which is the case of missing 1420 records of data
...
fill_missing_combined_data('MSZoning', mode(combined_data['MSZoning'])) #RL
fill_missing_combined_data('Utilities', mode(combined_data['Utilities'])) #AllPub
fill_missing_combined_data('Exterior1st', mode(combined_data['Exterior1st'])) #VinylSd
fill_missing_combined_data('Exterior2nd', mode(combined_data['Exterior2nd'])) #VinylSd
fill_missing_combined_data('Electrical', mode(combined_data['Electrical'])) #Sbrkr
fill_missing_combined_data('KitchenQual', mode(combined_data['KitchenQual'])) #TA
fill_missing_combined_data('Functional', mode(combined_data['Functional'])) #Typ
fill_missing_combined_data('SaleType', mode(combined_data['SaleType'])) #WD
